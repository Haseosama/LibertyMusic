<div align="center">
  ...
  <p>
    <b>Liberty Music</b> is a <a href="https://github.com/knighthat/Kreate">Kreate</a> fork (itself a <a href="https://github.com/fast4x/RiMusic">RiMusic</a> fork) with performance in mind
  </p>
...
> **²** This feature only available on GitHub builds (`LibertyMusic-release.apk` and `LibertyMusic-uncompressed.apk`)
...
Liberty Music is a personal fork built on top of [Kreate](https://github.com/knighthat/Kreate), which itself is built
on top of [RiMusic](https://github.com/fast4x/RiMusic). It has no relation to either original author/maintainer.
