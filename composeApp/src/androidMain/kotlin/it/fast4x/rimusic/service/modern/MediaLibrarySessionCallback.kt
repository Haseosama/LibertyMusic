...
class MediaLibrarySessionCallback(
    ...
    // media3 added a 3-arg overload with `isForPlayback` to distinguish real resumption
    // from boot-time info gathering; migrating would change when playback auto-starts
    // and needs verification against boot-time behavior, so keep this override as-is.
