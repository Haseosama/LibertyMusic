...
import app.kreate.android.variant.BuildConfig
...
object Updater : KoinComponent {
    ...
    fun checkForUpdate(
        ...
        try {
            ...
            val isNewUpdateAvailable = trimVersion( AppInfo.versionName ) != trimVersion( tagName )
    ...
    fun getFileName(): String {
        ...
        return "%s-%s.apk".format(AppInfo.NAME.replace(" ", ""), suffix)
    }
}