...
fun GeneralSettings( paddingValues: PaddingValues ) {
    ...
    Column(
        ...
        LazyColumn(
            ...
            UpdateFeatureHolder.feature?.run { updateSection( search ) }
            ...
            entry( search, R.string.setting_entry_app_region ) {
                SettingComponents.ListEntry(
                    ...
                    getName = {
                        // Locale.Builder() needs API 24+, below this app's minSdk 23 — keep
                        // the deprecated two-arg constructor rather than gate it by version.
