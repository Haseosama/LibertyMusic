...
@Composable
// confirmValueChange is deprecated without replacement — the suggested migration
// (dynamic anchors / SwipeToDismissBox's onDismissed) changes when the swipe action
// fires and needs behavioral verification, so keep the veto-callback approach here.
