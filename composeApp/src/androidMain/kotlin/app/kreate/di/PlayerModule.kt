...
val playerModule = module {
    ...
    single<StatefulPlayer> {
        ...
        val audioAttributes = AudioAttributes.Builder()
            ...
            // On some devices, spatializing plain stereo music routes it through a
            // hardware-tunneled spatializer/DSP effect path (e.g. Dolby Atmos) whose
            // gain stage doesn't correctly follow the stream/app volume — resulting in
            // audio that stays at full level even when both report muted. Opting out
            // keeps playback on the normal, correctly-attenuated mixer path.
