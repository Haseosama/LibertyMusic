...
open class ChangelogsDialog(context: Context): Dialog() {
    ...
    override val dialogTitle: String
        @Composable
        get() = stringResource( R.string.update_changelogs, AppInfo.versionName )
    ...
    // TabRow/TabRowDefaults.tabIndicatorOffset are deprecated in favor of
    // PrimaryTabRow + TabIndicatorScope.tabIndicatorOffset, but that migration can't be
    // compile-verified in this environment — keeping the known-working deprecated API.
