...
// activeNetworkInfo is deprecated in favor of NetworkCapabilities, kept here only for
// the pre-Android-6 fallback branch below (NetworkCapabilities needs API 23+).
...
// fetchedLyrics is a var captured by Database.asyncTransaction's non-inline lambda, so
// the null-check above can't smart-cast it there — kotlinc's "unnecessary !!" warning
// below is a false positive: removing it is a real compile error.
